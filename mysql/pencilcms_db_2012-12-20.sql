...
# Generation Time: 2012-12-20 06:01:24 +0000
# ************************************************************
...
# Dump of table pencil_page_descriptor
# ------------------------------------------------------------

DROP TABLE IF EXISTS `pencil_page_descriptor`;

CREATE TABLE `pencil_page_descriptor` (
  `page_id` bigint(20) unsigned NOT NULL,
